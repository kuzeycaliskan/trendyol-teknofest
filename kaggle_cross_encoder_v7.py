"""
Cross-encoder v7 — masaüstü (RTX 4070). "Her şey dahil" sürümü:
...
np.save(f"{OUT}/ce7_test_scores.npy", predict_chunked(test))
print("Bitti. İndirilecek TEK dosya: ce7_test_scores.npy")
