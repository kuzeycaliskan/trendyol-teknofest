"""
Cross-encoder v12 — masaüstü (RTX 4070), GECE İŞİ: ConvBERT.
dbmdz/convbert-base-turkish-mc4-uncased — yerli Türkçe ama FARKLI mimari
(konvolüsyonlu dikkat) → ensemble'a XLM'siz çeşitlilik adayı. Reçete ce11
ile aynı (tüm veri + mined + sameleaf çelişki negatifleri). Süre: ~2 saat.
...
BASE_MODEL = "dbmdz/convbert-base-turkish-mc4-uncased"
MAX_LEN = 160
...
np.save(f"{OUT}/ce12_test_scores.npy", predict_chunked(test))
print("Bitti. İndirilecek TEK dosya: ce12_test_scores.npy")
