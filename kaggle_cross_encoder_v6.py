"""
Cross-encoder v6 — KAGGLE NOTEBOOK'TA (GPU ile) çalıştırılır. ENDGAME SÜRÜMÜ.
...
np.save(f"{OUT}/ce6_test_scores.npy", predict_chunked(test))
print("Bitti. İndirilecek TEK dosya: ce6_test_scores.npy")
