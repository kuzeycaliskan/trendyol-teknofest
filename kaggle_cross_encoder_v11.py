"""
Cross-encoder v11 — masaüstü (RTX 4070). T1 HAMLESI: aynı-leaf çelişki
negatifleri İLK KEZ eğitimde. ce7 reçetesi (dbmdz, tüm veri, 2ep, attr 400,
len 160) + sameleaf_negatives.csv (sorgu spec-token çelişkisi kanıtlı,
leaf-koruması istisnası). Süre: ~2.5-3 saat.
...
np.save(f"{OUT}/ce11_test_scores.npy", predict_chunked(test))
print("Bitti. İndirilecek TEK dosya: ce11_test_scores.npy")
