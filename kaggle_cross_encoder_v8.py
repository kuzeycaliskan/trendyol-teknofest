"""
Cross-encoder v7 — masaüstü (RTX 4070). ce7'nin SEED=43 kopyası (seed çeşitliliği):
dbmdz + TÜM veri (val'siz) + 2 epoch + zengin girdi (attr 400, max_len 160).
ce6'dan tek fark girdi zenginliği. Süre: ~3.5 saat.
...
np.save(f"{OUT}/ce8_test_scores.npy", predict_chunked(test))
print("Bitti. İndirilecek TEK dosya: ce8_test_scores.npy")
